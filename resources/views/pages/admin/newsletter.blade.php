<x-template.admin title="Newsletter" slug="newsletter">
        ...
        <tbody>
            <tr>
                <td width="100%" valign="top" height="100%">
                        ...
                        <table class="form">
                            <tbody>
                                <tr>
                                    <th>Receipient(s):</th>
                                    <td>
                                        <select id="changeRecipient" name="to" class="inpts"
                                ...
                                <tr id="userNameRow">
                                    <th>Username:</th>
                                    <td><input type="text" name="username" value="" class="inpts"
                                            size="30" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>Subject:</th>
                                    <td><input type="text" name="subject" value="" class="inpts" required />
                                    </td>
                                </tr>
                                <tr class="row2">
                                    <th>Message:<br></th>
                                    <td>
                                        <textarea name="message" class="inpts" rows="10"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th></th>
                    ...
                    <div class="alert alert-warning"> Send a newsletter:<br> This form helps you to send a newsletter to
                        one
                        or several users.<br> Select a user or a user group, type a subject and a message text. Click on
                        the
                        'send newsletter' button once! If you selected a user, the email will be sent immediately. But
                        if it
                        is a user group, it will be added to the email queue. All emails on queue will be sent in the
                        background so you can continue what you are doing. 200 emails will be sent every 5 minutes; if
                        you
