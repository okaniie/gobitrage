<x-template.guest>
    <x-general.page-banner>FAQs</x-general.page-banner>

    <section class="section_2 my-5">
        <div class="container">
            <div class="section-heading">
                <h4 class="my-5">Have Any Questions?</h4>
                <div class="section-heading-line-left"></div>
            </div>
            <div class="row mt-40">
                <div class="col-md-6 col-sm-6 col-12">
                    <div class="pr-30-md">
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc1">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse" data-parent="#accordion2"
                                        data-bs-target="#ac_col1" aria-expanded="true" aria-controls="ac_col1">What is
                                        {{ config('app.name', 'Crypto HYIP') }}? </a>
                                </h4>
                            </div>
                            <div id="ac_col1" class="panel-collapse collapse in" role="tabpanel"
                                aria-labelledby="acc1">
                                <div class="panel-body accordion-body">
                                    {{ config('app.name', 'Crypto HYIP') }} is founded by a team of professional Forex
                                    &amp; Crypto traders who
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc2">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col2" aria-expanded="false"
                                        aria-controls="ac_col2"> Is {{ config('app.name', 'Crypto HYIP') }}
                                        officially registered?</a>
                                </h4>
                            </div>
                            <div id="ac_col2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="acc2">
                                <div class="panel-body accordion-body">
                                    Yes. {{ config('app.name', 'Crypto HYIP') }} is a legally registered investment
                                    company incorporated and
                                    headquartered in London, England. <a href="assets/images/investorm-certificate.png"
                                        target="_blank">Click
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc3">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col3" aria-expanded="false"
                                        aria-controls="ac_col3"> Who can create an
                                        account with {{ config('app.name', 'Crypto HYIP') }}? </a>
                                </h4>
                            </div>
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc4">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col4" aria-expanded="false"
                                        aria-controls="ac_col4"> How do I create
                                        my account with {{ config('app.name', 'Crypto HYIP') }}? </a>
                                </h4>
                            </div>
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc5">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col5" aria-expanded="false"
                                        aria-controls="ac_col5"> Can I have more
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc6">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col6" aria-expanded="false"
                                        aria-controls="ac_col6">What do I need to
                                        start trading or investing with {{ config('app.name', 'Crypto HYIP') }}? </a>
                                </h4>
                            </div>
                            <div id="ac_col6" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc7">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col7" aria-expanded="false"
                                        aria-controls="ac_col7"> How many times
                                        can a user make deposits into their account? </a>
                                </h4>
                            </div>
                            <div id="ac_col7" class="panel-collapse collapse" role="tabpanel"
                    ...
                    <div class="pr-30-md">
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc8">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse" data-parent="#accordion2"
                                        data-bs-target="#ac_col8" aria-expanded="true" aria-controls="ac_col8"> What
                                        payment methods can I use to
                                        make a deposit? </a>
                                </h4>
                            </div>
                            <div id="ac_col8" class="panel-collapse collapse in" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc9">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col9" aria-expanded="false"
                                        aria-controls="ac_col9"> What is the
                                        Minimum / Maximum amount allowed to deposit? </a>
                                </h4>
                            </div>
                            <div id="ac_col9" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc10">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col10" aria-expanded="false"
                                        aria-controls="ac_col10"> Can I make
                                        reinvestments? </a>
                                </h4>
                            </div>
                            <div id="ac_col10" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc11">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col11" aria-expanded="false"
                                        aria-controls="ac_col11"> Do I get my
                                        investment principal back? </a>
                                </h4>
                            </div>
                            <div id="ac_col11" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc12">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col112" aria-expanded="false"
                                        aria-controls="ac_col112"> What is the
                                        minimum amount for withdrawal? </a>
                                </h4>
                            </div>
                            <div id="ac_col112" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc13">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col13" aria-expanded="false"
                                        aria-controls="ac_col13"> Are there any
                                        fees to withdraw my funds? </a>
                                </h4>
                            </div>
                            <div id="ac_col13" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="card p-3 mb-3 accordion">
                            <div class="panel-heading accordion-heading" role="tab" id="acc14">
                                <h4 class="panel-title accordion-title">
                                    <a class="collapsed text-decoration-none text-dark" role="button" data-bs-toggle="collapse"
                                        data-parent="#accordion2" data-bs-target="#ac_col14" aria-expanded="false"
                                        aria-controls="ac_col14"> Do you have an
                                        affiliate program? </a>
                                </h4>
                            </div>
                            <div id="ac_col14" class="panel-collapse collapse" role="tabpanel"
